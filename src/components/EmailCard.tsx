...
export const EmailCard = () => {
  ...
  return (
    <div className="w-full max-w-2xl px-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="bg-card border border-border p-6 rounded-[2rem] shadow-xl shadow-primary/5 flex flex-col md:flex-row items-center gap-6">
        <div className="flex-1 text-center md:text-left overflow-hidden">
          <p className="text-sm font-medium text-muted-foreground mb-1">Your temporary email</p>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={cn(
              ...
              copied ? "bg-green-500 text-white" : "bg-secondary text-foreground hover:bg-secondary/80"
            )}
          ...
          <button
            ...
            className="flex items-center justify-center w-12 h-12 rounded-2xl bg-secondary text-foreground hover:bg-secondary/80 transition-all"
            title="Refresh inbox"
          >
          ...
          <button
            ...
            className="flex items-center justify-center w-12 h-12 rounded-2xl bg-red-500/10 text-red-500 hover:bg-red-500/20 transition-all"
